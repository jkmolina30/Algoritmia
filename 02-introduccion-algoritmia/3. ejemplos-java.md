...
NOTA: Para entender un poco mas sobre el orden en el que se resuelven las operaciones, te invito a ingresar al siguiente enlace: [Jerarquia de Operaciones](jerarquia-operaciones.md)
